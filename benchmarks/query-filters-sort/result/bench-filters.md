...
| Nodes          | page queries, latest | page queries, lmdb | indexing (latest) | indexing (lmdb) |
| -------------- | -------------------- | ------------------ | ----------------- | --------------- |
...
| 10000 (small)  | 210                   | 224                 | 147                     | 142                   |
| 10000 (big)    | 255                   | 226                 | 189                     | 141                   |
| 100000 (small) | 429                   | 395                 | 226                     | 149                   |
| 100000 (big)   | 782                   | 420                 | 709                     | 150                   |
...
| Nodes          | rss peak, MB (latest) | rss peak, MB (lmdb) | heap total, MB (latest) | heap total, MB (lmdb) |
| -------------- | --------------------- | ------------------- | ----------------------- | --------------------- |
| 1000 (small)   | 201                   | 206                 | 139                     | 138                   |
| 1000 (big)     | 209                   | 216                 | 147                     | 137                   |
| 10000 (small)  | 212                   | 223                 | 149                     | 142                   |
| 10000 (big)    | 279                   | 361                 | 218                     | 142                   |
| 100000 (small) | 673                   | 495                 | 233                     | 149                   |
| 100000 (big)   | 900                   | 1247                | 739                     | 153                   |
...
| Nodes          | rss peak, MB (latest) | rss peak, MB (lmdb) | heap total, MB (latest) | heap total, MB (lmdb) |
| -------------- | --------------------- | ------------------- | ----------------------- | --------------------- |
| 1000 (small)   | 205                   | 204                 | 140                     | 138                   |
| 1000 (big)     | 208                   | 219                 | 147                     | 138                   |
| 10000 (small)  | 210                   | 224                 | 147                     | 141                   |
| 10000 (big)    | 277                   | 361                 | 214                     | 141                   |
| 100000 (small) | 746                   | 451                 | 308                     | 152                   |
| 100000 (big)   | 1001                  | 1252                | 820                     | 149                   |
...
| Nodes          | rss peak, MB (latest) | rss peak, MB (lmdb) | heap total, MB (latest) | heap total, MB (lmdb) |
| -------------- | --------------------- | ------------------- | ----------------------- | --------------------- |
| 1000 (small)   | 201                   | 204                 | 139                     | 137                   |
| 1000 (big)     | 210                   | 204                 | 148                     | 138                   |
| 10000 (small)  | 213                   | 225                 | 152                     | 143                   |
| 10000 (big)    | 280                   | 278                 | 219                     | 150                   |
| 100000 (small) | 432                   | 493                 | 277                     | 151                   |
| 100000 (big)   | 923                   | 683                 | 736                     | 183                   |
...
| Nodes          | rss peak, MB (latest) | rss peak, MB (lmdb) | heap total, MB (latest) | heap total, MB (lmdb) |
| -------------- | --------------------- | ------------------- | ----------------------- | --------------------- |
| 1000 (small)   | 201                   | 204                 | 139                     | 138                   |
| 1000 (big)     | 208                   | 206                 | 145                     | 140                   |
| 10000 (small)  | 216                   | 224                 | 154                     | 143                   |
| 10000 (big)    | 268                   | 282                 | 191                     | 155                   |
| 100000 (small) | 942                   | 496                 | 505                     | 187                   |
| 100000 (big)   | 1320                  | 671                 | 822                     | 166                   |
